...
QuickFiller::QuickFiller(const ParameterSet& iConfig, TTree* iTree, BEANhelper* iBEANhelper) : NtupleFiller(iConfig, iBEANhelper){
	...
	tauMatch = fs->make<TH1D>("TauMatch",			"Tau Match",			20, -10, 10);
	tauMatch_pu = fs->make<TH1D>("TauMatch_PURW",		"Tau Match PURW",		20, -10, 10);
	tauMatchParentVsTauMatch = fs->make<TH2D>("ParentVsMatch",		"Parent Vs Match",		20, -10, 10, 20, -10, 10);
	tauMatchParentVsTauMatch_pu = fs->make<TH2D>("ParentVsMatch_PURW", "Parent Vs Match PURW",	20, -10, 10, 20, -10, 10);

	tau1Match = fs->make<TH1D>("Tau1Match",				"Tau1 Match",					20, -10, 10);
	tau1Match_pu = fs->make<TH1D>("Tau1Match_PURW",			"Tau1 Match PURW",				20, -10, 10);
	tau1MatchParentVsTauMatch = fs->make<TH2D>("ParentVsTau1Match",		"Parent Vs Tau1 Match",			20, -10, 10, 20, -10, 10);
	tau1MatchParentVsTauMatch_pu = fs->make<TH2D>("ParentVsTau1Match_PURW", "Parent Vs Tau1 Match PURW",	20, -10, 10, 20, -10, 10);

	tau2Match = fs->make<TH1D>("Tau2Match",				"Tau2 Match",					20, -10, 10);
	tau2Match_pu = fs->make<TH1D>("Tau2Match_PURW",			"Tau2 Match PURW",				20, -10, 10);
	tau2MatchParentVsTauMatch = fs->make<TH2D>("ParentVsTau2Match",		"Parent Vs Tau2 Match",			20, -10, 10, 20, -10, 10);
	tau2MatchParentVsTauMatch_pu = fs->make<TH2D>("ParentVsTau2Match_PURW", "Parent Vs Tau2 Match PURW",	20, -10, 10, 20, -10, 10);

	tau2MPvsTau1MP = fs->make<TH2F>("tau2MPvsTau1MP", "tau2MPvsTau1MP",    45, -10, 35, 45, -10, 35);


	tau1_fromH_pt = fs->make<TH1F>("tau1_fromH_pt",						"tau1_fromH_pt",					50, 0, 100);
	tau1_fromH_eta = fs->make<TH1F>("tau1_fromH_eta",						"tau1_fromH_eta",					50, -3, -3);
	tau1_fromH_nProngs = fs->make<TH1F>("tau1_fromH_nProngs",					"tau1_fromH_nProngs",				5, 0, 5);
	tau1_fromH_dm = fs->make<TH1F>("tau1_fromH_dm",						"tau1_fromH_dm",					20, 0, 20);
	tau1_fromH_nSignalGammas = fs->make<TH1F>("tau1_fromH_nSignalGammas",			"tau1_fromH_nSignalGammas",			10, 0, 10);
	tau1_fromH_nSignalNeutrals = fs->make<TH1F>("tau1_fromH_nSignalNeutrals",			"tau1_fromH_nSignalNeutrals",		10, 0, 10);
	tau1_fromH_antiElectronIndex = fs->make<TH1F>("tau1_fromH_antiElectronIndex",		"tau1_fromH_antiElectronIndex",		5, 0, 5);
	tau1_fromH_antiMuonIndex = fs->make<TH1F>("tau1_fromH_antiMuonIndex",			"tau1_fromH_antiMuonIndex",			5, 0, 5);
	tau1_fromH_isoIndex = fs->make<TH1F>("tau1_fromH_isoIndex",				"tau1_fromH_isoIndex",				5, 0, 5);
	tau1_fromH_ltPt = fs->make<TH1F>("tau1_fromH_ltPt",					"tau1_fromH_ltPt",					30, 0, 60);
	tau1_fromW_pt = fs->make<TH1F>("tau1_fromW_pt",						"tau1_fromW_pt",					50, 0, 100);
	tau1_fromW_eta = fs->make<TH1F>("tau1_fromW_eta",						"tau1_fromW_eta",					50, -3, -3);
	tau1_fromW_nProngs = fs->make<TH1F>("tau1_fromW_nProngs",					"tau1_fromW_nProngs",				5, 0, 5);
	tau1_fromW_dm = fs->make<TH1F>("tau1_fromW_dm",						"tau1_fromW_dm",					20, 0, 20);
	tau1_fromW_nSignalGammas = fs->make<TH1F>("tau1_fromW_nSignalGammas",			"tau1_fromW_nSignalGammas",			10, 0, 10);
	tau1_fromW_nSignalNeutrals = fs->make<TH1F>("tau1_fromW_nSignalNeutrals",			"tau1_fromW_nSignalNeutrals",		10, 0, 10);
	tau1_fromW_antiElectronIndex = fs->make<TH1F>("tau1_fromW_antiElectronIndex",		"tau1_fromW_antiElectronIndex",		5, 0, 5);
	tau1_fromW_antiMuonIndex = fs->make<TH1F>("tau1_fromW_antiMuonIndex",			"tau1_fromW_antiMuonIndex",			5, 0, 5);
	tau1_fromW_isoIndex = fs->make<TH1F>("tau1_fromW_isoIndex",				"tau1_fromW_isoIndex",				5, 0, 5);
	tau1_fromW_ltPt = fs->make<TH1F>("tau1_fromW_ltPt",					"tau1_fromW_ltPt",					30, 0, 60);
	tau1_fromOther_pt = fs->make<TH1F>("tau1_fromOther_pt",					"tau1_fromOther_pt",				50, 0, 100);
	tau1_fromOther_eta = fs->make<TH1F>("tau1_fromOther_eta",					"tau1_fromOther_eta",				50, -3, -3);
	tau1_fromOther_nProngs = fs->make<TH1F>("tau1_fromOther_nProngs",				"tau1_fromOther_nProngs",			5, 0, 5);
	tau1_fromOther_dm = fs->make<TH1F>("tau1_fromOther_dm",					"tau1_fromOther_dm",				20, 0, 20);
	tau1_fromOther_nSignalGammas = fs->make<TH1F>("tau1_fromOther_nSignalGammas",		"tau1_fromOther_nSignalGammas",		10, 0, 10);
	tau1_fromOther_nSignalNeutrals = fs->make<TH1F>("tau1_fromOther_nSignalNeutrals",		"tau1_fromOther_nSignalNeutrals",	10, 0, 10);
	tau1_fromOther_antiElectronIndex = fs->make<TH1F>("tau1_fromOther_antiElectronIndex",	"tau1_fromOther_antiElectronIndex",	5, 0, 5);
	tau1_fromOther_antiMuonIndex = fs->make<TH1F>("tau1_fromOther_antiMuonIndex",		"tau1_fromOther_antiMuonIndex",		5, 0, 5);
	tau1_fromOther_isoIndex = fs->make<TH1F>("tau1_fromOther_isoIndex",			"tau1_fromOther_isoIndex",			5, 0, 5);
	tau1_fromOther_ltPt = fs->make<TH1F>("tau1_fromOther_ltPt",				"tau1_fromOther_ltPt",				30, 0, 60);
	tau2_fromH_pt = fs->make<TH1F>("tau2_fromH_pt",						"tau2_fromH_pt",					50, 0, 100);
	tau2_fromH_eta = fs->make<TH1F>("tau2_fromH_eta",						"tau2_fromH_eta",					50, -3, -3);
	tau2_fromH_nProngs = fs->make<TH1F>("tau2_fromH_nProngs",					"tau2_fromH_nProngs",				5, 0, 5);
	tau2_fromH_dm = fs->make<TH1F>("tau2_fromH_dm",						"tau2_fromH_dm",					20, 0, 20);
	tau2_fromH_nSignalGammas = fs->make<TH1F>("tau2_fromH_nSignalGammas",			"tau2_fromH_nSignalGammas",			10, 0, 10);
	tau2_fromH_nSignalNeutrals = fs->make<TH1F>("tau2_fromH_nSignalNeutrals",			"tau2_fromH_nSignalNeutrals",		10, 0, 10);
	tau2_fromH_antiElectronIndex = fs->make<TH1F>("tau2_fromH_antiElectronIndex",		"tau2_fromH_antiElectronIndex",		5, 0, 5);
	tau2_fromH_antiMuonIndex = fs->make<TH1F>("tau2_fromH_antiMuonIndex",			"tau2_fromH_antiMuonIndex",			5, 0, 5);
	tau2_fromH_isoIndex = fs->make<TH1F>("tau2_fromH_isoIndex",				"tau2_fromH_isoIndex",				5, 0, 5);
	tau2_fromH_ltPt = fs->make<TH1F>("tau2_fromH_ltPt",					"tau2_fromH_ltPt",					30, 0, 60);
	tau2_fromW_pt = fs->make<TH1F>("tau2_fromW_pt",						"tau2_fromW_pt",					50, 0, 100);
	tau2_fromW_eta = fs->make<TH1F>("tau2_fromW_eta",						"tau2_fromW_eta",					50, -3, -3);
	tau2_fromW_nProngs = fs->make<TH1F>("tau2_fromW_nProngs",					"tau2_fromW_nProngs",				5, 0, 5);
	tau2_fromW_dm = fs->make<TH1F>("tau2_fromW_dm",						"tau2_fromW_dm",					20, 0, 20);
	tau2_fromW_nSignalGammas = fs->make<TH1F>("tau2_fromW_nSignalGammas",			"tau2_fromW_nSignalGammas",			10, 0, 10);
	tau2_fromW_nSignalNeutrals = fs->make<TH1F>("tau2_fromW_nSignalNeutrals",			"tau2_fromW_nSignalNeutrals",		10, 0, 10);
	tau2_fromW_antiElectronIndex = fs->make<TH1F>("tau2_fromW_antiElectronIndex",		"tau2_fromW_antiElectronIndex",		5, 0, 5);
	tau2_fromW_antiMuonIndex = fs->make<TH1F>("tau2_fromW_antiMuonIndex",			"tau2_fromW_antiMuonIndex",			5, 0, 5);
	tau2_fromW_isoIndex = fs->make<TH1F>("tau2_fromW_isoIndex",				"tau2_fromW_isoIndex",				5, 0, 5);
	tau2_fromW_ltPt = fs->make<TH1F>("tau2_fromW_ltPt",					"tau2_fromW_ltPt",					30, 0, 60);
	tau2_fromOther_pt = fs->make<TH1F>("tau2_fromOther_pt",					"tau2_fromOther_pt",				50, 0, 100);
	tau2_fromOther_eta = fs->make<TH1F>("tau2_fromOther_eta",					"tau2_fromOther_eta",				50, -3, -3);
	tau2_fromOther_nProngs = fs->make<TH1F>("tau2_fromOther_nProngs",				"tau2_fromOther_nProngs",			5, 0, 5);
	tau2_fromOther_dm = fs->make<TH1F>("tau2_fromOther_dm",					"tau2_fromOther_dm",				20, 0, 20);
	tau2_fromOther_nSignalGammas = fs->make<TH1F>("tau2_fromOther_nSignalGammas",		"tau2_fromOther_nSignalGammas",		10, 0, 10);
	tau2_fromOther_nSignalNeutrals = fs->make<TH1F>("tau2_fromOther_nSignalNeutrals",		"tau2_fromOther_nSignalNeutrals",	10, 0, 10);
	tau2_fromOther_antiElectronIndex = fs->make<TH1F>("tau2_fromOther_antiElectronIndex",	"tau2_fromOther_antiElectronIndex",	5, 0, 5);
	tau2_fromOther_antiMuonIndex = fs->make<TH1F>("tau2_fromOther_antiMuonIndex",		"tau2_fromOther_antiMuonIndex",		5, 0, 5);
	tau2_fromOther_isoIndex = fs->make<TH1F>("tau2_fromOther_isoIndex",			"tau2_fromOther_isoIndex",			5, 0, 5);
	tau2_fromOther_ltPt = fs->make<TH1F>("tau2_fromOther_ltPt",				"tau2_fromOther_ltPt",				30, 0, 60);
	tau12_fromH_pt = fs->make<TH1F>("tau12_fromH_pt",						"tau12_fromH_pt",					50, 0, 100);
	tau12_fromH_eta = fs->make<TH1F>("tau12_fromH_eta",					"tau12_fromH_eta",					50, -3, -3);
	tau12_fromH_nProngs = fs->make<TH1F>("tau12_fromH_nProngs",				"tau12_fromH_nProngs",				5, 0, 5);
	tau12_fromH_dm = fs->make<TH1F>("tau12_fromH_dm",						"tau12_fromH_dm",					20, 0, 20);
	tau12_fromH_nSignalGammas = fs->make<TH1F>("tau12_fromH_nSignalGammas",			"tau12_fromH_nSignalGammas",		10, 0, 10);
	tau12_fromH_nSignalNeutrals = fs->make<TH1F>("tau12_fromH_nSignalNeutrals",		"tau12_fromH_nSignalNeutrals",		10, 0, 10);
	tau12_fromH_antiElectronIndex = fs->make<TH1F>("tau12_fromH_antiElectronIndex",		"tau12_fromH_antiElectronIndex",	5, 0, 5);
	tau12_fromH_antiMuonIndex = fs->make<TH1F>("tau12_fromH_antiMuonIndex",			"tau12_fromH_antiMuonIndex",		5, 0, 5);
	tau12_fromH_isoIndex = fs->make<TH1F>("tau12_fromH_isoIndex",				"tau12_fromH_isoIndex",				5, 0, 5);
	tau12_fromH_ltPt = fs->make<TH1F>("tau12_fromH_ltPt",					"tau12_fromH_ltPt",					30, 0, 60);
	tau12_fromW_pt = fs->make<TH1F>("tau12_fromW_pt",						"tau12_fromW_pt",					50, 0, 100);
	tau12_fromW_eta = fs->make<TH1F>("tau12_fromW_eta",					"tau12_fromW_eta",					50, -3, -3);
	tau12_fromW_nProngs = fs->make<TH1F>("tau12_fromW_nProngs",				"tau12_fromW_nProngs",				5, 0, 5);
	tau12_fromW_dm = fs->make<TH1F>("tau12_fromW_dm",						"tau12_fromW_dm",					20, 0, 20);
	tau12_fromW_nSignalGammas = fs->make<TH1F>("tau12_fromW_nSignalGammas",			"tau12_fromW_nSignalGammas",		10, 0, 10);
	tau12_fromW_nSignalNeutrals = fs->make<TH1F>("tau12_fromW_nSignalNeutrals",		"tau12_fromW_nSignalNeutrals",		10, 0, 10);
	tau12_fromW_antiElectronIndex = fs->make<TH1F>("tau12_fromW_antiElectronIndex",		"tau12_fromW_antiElectronIndex",	5, 0, 5);
	tau12_fromW_antiMuonIndex = fs->make<TH1F>("tau12_fromW_antiMuonIndex",			"tau12_fromW_antiMuonIndex",		5, 0, 5);
	tau12_fromW_isoIndex = fs->make<TH1F>("tau12_fromW_isoIndex",				"tau12_fromW_isoIndex",				5, 0, 5);
	tau12_fromW_ltPt = fs->make<TH1F>("tau12_fromW_ltPt",					"tau12_fromW_ltPt",					30, 0, 60);
	tau12_fromOther_pt = fs->make<TH1F>("tau12_fromOther_pt",					"tau12_fromOther_pt",				50, 0, 100);
	tau12_fromOther_eta = fs->make<TH1F>("tau12_fromOther_eta",				"tau12_fromOther_eta",				50, -3, -3);
	tau12_fromOther_nProngs = fs->make<TH1F>("tau12_fromOther_nProngs",			"tau12_fromOther_nProngs",			5, 0, 5);
	tau12_fromOther_dm = fs->make<TH1F>("tau12_fromOther_dm",					"tau12_fromOther_dm",				20, 0, 20);
	tau12_fromOther_nSignalGammas = fs->make<TH1F>("tau12_fromOther_nSignalGammas",		"tau12_fromOther_nSignalGammas",	10, 0, 10);
	tau12_fromOther_nSignalNeutrals = fs->make<TH1F>("tau12_fromOther_nSignalNeutrals",	"tau12_fromOther_nSignalNeutrals",	10, 0, 10);
	tau12_fromOther_antiElectronIndex = fs->make<TH1F>("tau12_fromOther_antiElectronIndex",	"tau12_fromOther_antiElectronIndex",5, 0, 5);
	tau12_fromOther_antiMuonIndex = fs->make<TH1F>("tau12_fromOther_antiMuonIndex",		"tau12_fromOther_antiMuonIndex",	5, 0, 5);
	tau12_fromOther_isoIndex = fs->make<TH1F>("tau12_fromOther_isoIndex",			"tau12_fromOther_isoIndex",			5, 0, 5);
	tau12_fromOther_ltPt = fs->make<TH1F>("tau12_fromOther_ltPt",				"tau12_fromOther_ltPt",				30, 0, 60);
